...
autos = [{"brand": "Ford", "model": "Mustang", "year": 1964, 'price': 4000},
...
autos_ord = sorted(autos, key=lambda i: i['price'] or -1, reverse=True)
print('Sorted list of dicts is:')
for elem in autos_ord:
   print(elem)
